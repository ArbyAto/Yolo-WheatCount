...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.model = self.model_load(weights="runs/train/best.pt",
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        # todo 统一变化为更新左图
        self.img_num_label = QLabel("当前麦穗数量：待检测")
        ...
        # todo 添加摄像头检测标签逻辑
        self.vid_num_label = QLabel("当前麦穗数量：{}".format("等待检测"))
    ...
    def upload_img(self):
        ...
        if fileName:
            ...
            # todo 上传图片之后右侧的图片重置，
            # self.right_img.setPixmap(QPixmap("images/UI/right.jpeg"))
            self.img_num_label.setText("当前麦穗数量：待检测")
            # QLabel()
    ...
    def detect_vid(self):
        ...
        for path, im, im0s, vid_cap, s in self.dataset:
            ...
            for i, det in enumerate(pred):  # per image
                ...
                self.vid_num_label.setText("当前麦穗数量：{}".format(len(txt_results)))
    ...
    def reset_vid(self):
        ...
        self.vid_source = self.init_vid_id
        self.webcam = True
        self.vid_num_label.setText("当前麦穗数量：{}".format("等待检测"))
